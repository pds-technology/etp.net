...
{
    [AvroNamedType("DataArrayMetadata", "Energistics.Etp.v12.Datatypes.DataArrayTypes")]
    public partial class DataArrayMetadata
    {
        ...
        [AvroRecordField("preferredSubarrayDimensions")]
        public IList<long> PreferredSubarrayDimensions { get; set; }
        [AvroRecordField("transportArrayType")]
        public Energistics.Etp.v12.Datatypes.AnyArrayType TransportArrayType { get; set; }
        [AvroRecordField("logicalArrayType")]
        public Energistics.Etp.v12.Datatypes.AnyLogicalArrayType LogicalArrayType { get; set; }
