...
{
    [AvroNamedType("PutDataSubarraysType", "Energistics.Etp.v12.Datatypes.DataArrayTypes")]
    public partial class PutDataSubarraysType
    {
        ...
        public Energistics.Etp.v12.Datatypes.AnyArray Data { get; set; }
        [AvroRecordField("starts")]
        public IList<long> Starts { get; set; }
        [AvroRecordField("counts")]
        public IList<long> Counts { get; set; }
    }
}
