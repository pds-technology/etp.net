...
{
    [AvroNamedType("ChannelSubscribeInfo", "Energistics.Etp.v12.Datatypes.ChannelData")]
    public partial class ChannelSubscribeInfo
    {
        ...
        [AvroRecordField("requestLatestIndexCount")]
        [AvroNullable(true, "int")]
        public int? RequestLatestIndexCount { get; set; }
    }
}
