...
{
    [AvroNamedType("DataItem", "Energistics.Etp.v12.Datatypes.ChannelData")]
    public partial class DataItem
    {
        ...
        public Energistics.Etp.v12.Datatypes.DataValue Value { get; set; }
        [AvroRecordField("valueAttributes")]
        public IList<Energistics.Etp.v12.Datatypes.DataAttribute> ValueAttributes { get; set; }
    }
}
