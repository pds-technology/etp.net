...
{
    [AvroNamedType("TruncateInfo", "Energistics.Etp.v12.Datatypes.ChannelData")]
    public partial class TruncateInfo
    {
        ...
        [AvroRecordField("newEndIndex")]
        public Energistics.Etp.v12.Datatypes.IndexValue NewEndIndex { get; set; }
    }
}
