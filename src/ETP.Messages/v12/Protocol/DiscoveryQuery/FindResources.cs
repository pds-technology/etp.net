...
namespace Energistics.Etp.v12.Protocol.DiscoveryQuery
{
	...
	{
		public static Schema _SCHEMA = Avro.Schema.Parse(@"{""type"":""record"",""name"":""FindResources"",""namespace"":""Energistics.Etp.v12.Protocol.DiscoveryQuery"",""fields"":[{""name"":""uri"",""type"":""string""}],""messageType"":""1"",""protocol"":""13"",""senderRole"":""customer"",""protocolRoles"":""store,customer"",""fullName"":""Energistics.Etp.v12.Protocol.DiscoveryQuery.FindResources"",""depends"":[]}");
		private string _uri;
