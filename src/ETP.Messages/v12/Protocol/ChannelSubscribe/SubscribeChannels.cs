...
{
    [AvroNamedType("SubscribeChannels", "Energistics.Etp.v12.Protocol.ChannelSubscribe")]
    public partial class SubscribeChannels
    {
        public static string CanonicalSchema { get; } = "{\"type\":\"record\",\"name\":\"Energistics.Etp.v12.Protocol.ChannelSubscribe.SubscribeChannels\",\"fields\":[{\"name\":\"channels\",\"type\":{\"type\":\"map\",\"values\":{\"type\":\"record\",\"name\":\"Energistics.Etp.v12.Datatypes.ChannelData.ChannelSubscribeInfo\",\"fields\":[{\"name\":\"channelId\",\"type\":\"long\"},{\"name\":\"startIndex\",\"type\":{\"type\":\"record\",\"name\":\"Energistics.Etp.v12.Datatypes.IndexValue\",\"fields\":[{\"name\":\"item\",\"type\":[\"null\",\"long\",\"double\",{\"type\":\"record\",\"name\":\"Energistics.Etp.v12.Datatypes.ChannelData.PassIndexedDepth\",\"fields\":[{\"name\":\"pass\",\"type\":\"long\"},{\"name\":\"direction\",\"type\":{\"name\":\"Energistics.Etp.v12.Datatypes.ChannelData.PassDirection\",\"type\":\"enum\",\"symbols\":[\"Up\",\"HoldingSteady\",\"Down\"]}},{\"name\":\"depth\",\"type\":\"double\"}]}]}]}},{\"name\":\"dataChanges\",\"type\":\"boolean\"},{\"name\":\"requestLatestIndexCount\",\"type\":[\"null\",\"int\"]}]}}}]}";
        [AvroRecordField("channels")]
        public IDictionary<string, Energistics.Etp.v12.Datatypes.ChannelData.ChannelSubscribeInfo> Channels { get; set; }
    }
}
