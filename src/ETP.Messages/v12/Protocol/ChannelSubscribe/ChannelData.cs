...
namespace Energistics.Etp.v12.Protocol.ChannelSubscribe
{
	...
	public partial class ChannelData : ISpecificRecord
	{
		public static Schema _SCHEMA = Avro.Schema.Parse("{\"type\":\"record\",\"name\":\"ChannelData\",\"namespace\":\"Energistics.Etp.v12.Protocol.C" +
				"hannelSubscribe\",\"fields\":[{\"name\":\"data\",\"type\":{\"type\":\"array\",\"items\":{\"type\"" +
				...
				"1\",\"messageType\":\"4\",\"senderRole\":\"store\",\"protocolRoles\":\"store,customer\",\"mult" +
				"ipartFlag\":false,\"fullName\":\"Energistics.Etp.v12.Protocol.ChannelSubscribe.Chann" +
