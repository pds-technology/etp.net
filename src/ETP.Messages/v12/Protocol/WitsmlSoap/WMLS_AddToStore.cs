...
namespace Energistics.Etp.v12.Protocol.WitsmlSoap
{
	...
	public partial class WMLS_AddToStore : ISpecificRecord
	{
		public static Schema _SCHEMA = Avro.Schema.Parse(@"{""type"":""record"",""name"":""WMLS_AddToStore"",""namespace"":""Energistics.Etp.v12.Protocol.WitsmlSoap"",""fields"":[{""name"":""WMLtypeIn"",""type"":""string""},{""name"":""XMLin"",""type"":""string""},{""name"":""OptionsIn"",""type"":""string""},{""name"":""CapabilitiesIn"",""type"":""string""}],""protocol"":""8"",""messageType"":""1"",""senderRole"":""customer"",""protocolRoles"":""store,customer"",""multipartFlag"":false,""fullName"":""Energistics.Etp.v12.Protocol.WitsmlSoap.WMLS_AddToStore"",""depends"":[]}");
