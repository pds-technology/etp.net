...
namespace Energistics.Etp.v12.Protocol.GrowingObjectQuery
{
	...
	{
		public static Schema _SCHEMA = Avro.Schema.Parse(@"{""type"":""record"",""name"":""FindParts"",""namespace"":""Energistics.Etp.v12.Protocol.GrowingObjectQuery"",""fields"":[{""name"":""uri"",""type"":""string""}],""messageType"":""1"",""protocol"":""16"",""senderRole"":""customer"",""protocolRoles"":""store,customer"",""fullName"":""Energistics.Etp.v12.Protocol.GrowingObjectQuery.FindParts"",""depends"":[]}");
		private string _uri;
