...
namespace Energistics.Etp.v11.Protocol.StoreNotification
{
	...
	{
		public static Schema _SCHEMA = Avro.Schema.Parse("{\"type\":\"record\",\"name\":\"ChangeNotification\",\"namespace\":\"Energistics.Protocol.St" +
				...
				"s.Object.DataObject\"\r\n]}}],\"messageType\":\"2\",\"protocol\":\"5\",\"senderRole\":\"store\"" +
				",\"protocolRoles\":\"store,customer\",\"fullName\":\"Energistics.Protocol.StoreNotifica" +
				"tion.ChangeNotification\",\"depends\":[\r\n  \"Energistics.Datatypes.Object.ObjectChan" +
				"ge\"\r\n]}");
		private Energistics.Etp.v11.Datatypes.Object.ObjectChange _change;
		...
		public Energistics.Etp.v11.Datatypes.Object.ObjectChange Change
		{
			get
			{
				return this._change;
		...
		public virtual void Put(int fieldPos, object fieldValue)
		{
			switch (fieldPos)
			{
			case 0: this._change = (Energistics.Etp.v11.Datatypes.Object.ObjectChange)fieldValue; break;
