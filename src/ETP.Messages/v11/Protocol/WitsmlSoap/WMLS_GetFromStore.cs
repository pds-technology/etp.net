...
{
    [AvroNamedType("WMLS_GetFromStore", "Energistics.Protocol.WitsmlSoap")]
    public partial class WMLS_GetFromStore
    {
        public static string CanonicalSchema { get; } = "{\"type\":\"record\",\"name\":\"Energistics.Protocol.WitsmlSoap.WMLS_GetFromStore\",\"fields\":[{\"name\":\"WMLtypeIn\",\"type\":\"string\"},{\"name\":\"XMLin\",\"type\":\"string\"},{\"name\":\"OptionsIn\",\"type\":\"string\"},{\"name\":\"CapabilitiesIn\",\"type\":\"string\"}]}";
