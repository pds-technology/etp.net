...
namespace Energistics.Etp.v11.Protocol.WitsmlSoap
{
	...
	{
		public static Schema _SCHEMA = Avro.Schema.Parse(@"{""type"":""record"",""name"":""WMLS_GetBaseMsg"",""namespace"":""Energistics.Protocol.WitsmlSoap"",""fields"":[{""name"":""ReturnValueIn"",""type"":""int""}],""messageType"":""5"",""protocol"":""8"",""senderRole"":""customer"",""protocolRoles"":""store,customer"",""fullName"":""Energistics.Protocol.WitsmlSoap.WMLS_GetBaseMsg"",""depends"":[]}");
