...
{
    public class EncoderExtensionsGenerator : FileCodeGenerator<GenerationContext>
    {
        public EncoderExtensionsGenerator()
            : base("Energistics.Avro.Encoding", "EncoderExtensions.generated.cs")
        {
        }
        ...
        public override void Generate(GenerationContext context, CodeWriter writer)
        {
            ...
            {
                writer.XmlSummary($"Extension methods for encoders.");
                writer.WithPublicStaticPartialClass("EncoderExtensions", () =>
                {
                    writer.DeclareEncodeAvroObject();
